...
{
Game::Game()
    : m_window(WINDOW_WIDTH, WINDOW_HEIGHT, "Mineclone"), m_input(m_window),
      m_camera(glm::vec3(0.0f, 40.0f, 30.0f)), m_renderer(m_window, m_camera),
      m_world(m_camera, m_renderer), m_gui(m_renderer), m_hud(m_gui)
{
