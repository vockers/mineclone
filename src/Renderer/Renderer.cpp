...
Renderer::Renderer(Window &window, Camera &camera)
    : m_window(window), m_camera(camera),
      m_projection_settings(
          {45.0f, (float)window.getSize().x / (float)window.getSize().y, 0.1f, 1000.0f})
{
    ...
    m_cubemap_shader.loadFromFile("assets/shaders/cubemap_vertex.glsl",
                                  "assets/shaders/cubemap_fragment.glsl");

    m_skybox.generate("assets/textures/sky/top.png", "assets/textures/sky/bottom.png",
                      "assets/textures/sky/left.png", "assets/textures/sky/right.png",
                      "assets/textures/sky/front.png", "assets/textures/sky/back.png");
}
...
void Renderer::renderSkybox()
{
    ...
    glm::mat4 view =
        glm::mat4(glm::mat3(m_camera.getViewMatrix())); // remove translation from the view matrix
...
{
    return glm::perspective(glm::radians(m_projection_settings.fov), m_projection_settings.aspect,
                            m_projection_settings.near, m_projection_settings.far);
}
